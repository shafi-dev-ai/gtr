...
-- 1b. Profile creation error log (legacy/debug)
...
-- 1c. Phone verification codes (service-role managed)
...
-- Phone Verification Codes Policies (service-role only)
...
-- Function: Verify phone code and mark profile phone_verified (service role only)
